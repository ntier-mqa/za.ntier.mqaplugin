...
/** Generated Model for ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep
 *  @author iDempiere (generated)
 *  @version Release 12 - $Id$ */
@org.adempiere.base.Model(table="ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep")
public class X_ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep extends PO implements I_ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep, I_Persistent
{
    ...
    public X_ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep (Properties ctx, int ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID, String trxName)
    {
      super (ctx, ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID, trxName);
      /** if (ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID == 0)
        {
			setZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID (0);
        } */
    }

    /** Standard Constructor */
    public X_ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep (Properties ctx, int ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID, trxName, virtualColumns);
      /** if (ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID == 0)
        {
			setZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID (0);
        } */
    ...
    /** Standard Constructor */
    public X_ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep (Properties ctx, String ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU, String trxName)
    {
      super (ctx, ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU, trxName);
      /** if (ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU == null)
        {
			setZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID (0);
        } */
    }
    ...
    /** Standard Constructor */
    public X_ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep (Properties ctx, String ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU, trxName, virtualColumns);
      /** if (ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU == null)
        {
			setZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID (0);
        } */
    ...
    /** Load Constructor */
    public X_ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep[")
	...
	*/
	...
	/** Set Summary of Planned Employee Training Interventions.
		@param ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID Summary of Planned Employee Training Interventions
	*/
	public void setZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID (int ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID)
	{
		if (ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID < 1)
			set_ValueNoCheck (COLUMNNAME_ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID, Integer.valueOf(ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID));
	}

	/** Get Summary of Planned Employee Training Interventions.
		@return Summary of Planned Employee Training Interventions	  */
	public int getZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID()
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	/** Set ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU.
		@param ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU
	*/
	public void setZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU (String ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU)
	{
		set_Value (COLUMNNAME_ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU, ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU);
	}

	/** Get ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU.
		@return ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU	  */
	public String getZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU()
	{
		return (String)get_Value(COLUMNNAME_ZZ_WSP_ATR_Summ_Planned_Emp_Training_Inter_Rep_UU);
	}
