...
/** Generated Interface for ZZ_WSP_ATR_Induct_Ex_Leave_Training_Rep
 *  @author iDempiere (generated) 
 *  @version Release 12
 */
@SuppressWarnings("all")
public interface I_ZZ_WSP_ATR_Induct_Ex_Leave_Training_Rep 
{

    /** TableName=ZZ_WSP_ATR_Induct_Ex_Leave_Training_Rep */
    public static final String Table_Name = "ZZ_WSP_ATR_Induct_Ex_Leave_Training_Rep";
    ...
    /** Column name ZZ_Ex_Leave_Planned_Cnt */
    public static final String COLUMNNAME_ZZ_Ex_Leave_Planned_Cnt = "ZZ_Ex_Leave_Planned_Cnt";
    ...
    /** Column name ZZ_Ex_Leave_Trained_Cnt */
    public static final String COLUMNNAME_ZZ_Ex_Leave_Trained_Cnt = "ZZ_Ex_Leave_Trained_Cnt";
    ...
    /** Column name ZZ_Induction_Planned_Cnt */
    public static final String COLUMNNAME_ZZ_Induction_Planned_Cnt = "ZZ_Induction_Planned_Cnt";
    ...
    /** Column name ZZ_Induction_Trained_Cnt */
    public static final String COLUMNNAME_ZZ_Induction_Trained_Cnt = "ZZ_Induction_Trained_Cnt";
    ...
    /** Column name ZZ_Refresher_Planned */
    public static final String COLUMNNAME_ZZ_Refresher_Planned = "ZZ_Refresher_Planned";
    ...
    /** Column name ZZ_Refresher_Trained */
    public static final String COLUMNNAME_ZZ_Refresher_Trained = "ZZ_Refresher_Trained";
    ...
    /** Column name ZZ_WSP_ATR_Induct_Ex_Leave_Training_Rep_ID */
    public static final String COLUMNNAME_ZZ_WSP_ATR_Induct_Ex_Leave_Training_Rep_ID = "ZZ_WSP_ATR_Induct_Ex_Leave_Training_Rep_ID";

	/** Set Induction, Ex-leave and Refresher training done and planned.
	  * Summary of induction / ex-leave and refresher training done and planned. Please note each person was counted once, regardless of the number of interventions
	  */
    ...
    /** Column name ZZ_WSP_ATR_Induct_Ex_Leave_Training_Rep_UU */
    public static final String COLUMNNAME_ZZ_WSP_ATR_Induct_Ex_Leave_Training_Rep_UU = "ZZ_WSP_ATR_Induct_Ex_Leave_Training_Rep_UU";
    ...
    /** Column name ZZ_WSP_ATR_OFO_Major_Group_Ref_ID */
    public static final String COLUMNNAME_ZZ_WSP_ATR_OFO_Major_Group_Ref_ID = "ZZ_WSP_ATR_OFO_Major_Group_Ref_ID";

	/** Set OFO Major Group Ref.
	  * OFO Major Group Ref reference table
	  */
